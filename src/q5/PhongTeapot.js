...
//var lightPosition = vec4(0.2, 0.2, 1.0, 0.0 );
...
onload = function init()  {
    ...
    var myTeapot = teapot(9.0); //Nákvæmni?   JÁBB sýnist það
    ...
    gl.uniform4fv( gl.getUniformLocation(program, "lightPosition"), flatten(lightPosition) ); //FÆRA lightPosition miðað við örvalykla
    gl.uniform1f( gl.getUniformLocation(program, "shininess"), materialShininess );

    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            case 39:	// left arrow - snýr ljós niður x ás
                lightPosition[0] += 0.1;
                break;
            case 37:	// right arrow - snýr ljós upp x ás
                lightPosition[0] -= 0.1;
                break;
            case 38: // - Right arrow
                lightPosition[1] += 0.1;
        ...
        gl.uniform4fv( gl.getUniformLocation(program, "lightPosition"), flatten(lightPosition) ); //FÃ†RA lightPosition miÃ°aÃ° viÃ° Ã¶rvalykla
        myTeapot = teapot(inputNumber); 
        myTeapot.scale(0.5, 0.5, 0.5);
