...
var TIP_ARM_HEIGHT   = 2.0;
var TIP_ARM_WIDTH   = 0.5;
     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 87:	// w - snýr efri armi
                ...
                break;
            case 39:	// left arrow - snýr efri armi
			    theta[3] = Math.min(170, theta[3]+5);
                break;
            case 37:	// right arrow - snýr efri armi
...
function tipArm()
{
    var s = scalem(TIP_ARM_WIDTH, TIP_ARM_HEIGHT, TIP_ARM_WIDTH);
    var instanceMatrix = mult( translate( 0.0, 0.5 * TIP_ARM_HEIGHT, 0.0 ), s);
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t) );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
}
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, translate(0.0, LOWER_ARM_HEIGHT, 0.0));
    modelViewMatrix  = mult(modelViewMatrix, rotateZ( theta[TipArm] ) );
    tipArm();
